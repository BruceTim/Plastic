...
public class EmailController {
    ...
    @ResponseBody
    public String queryForState(@PathVariable("state") int state, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize) {
