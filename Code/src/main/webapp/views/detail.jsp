...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="resources/css/detail.css" media="all" />
    <link type="text/css" rel="stylesheet" href="resources/css/thickbox.css" media="all" />
    ...
    <script type="text/javascript" src="resources/js/lrroll.js"></script>
    <script type="text/javascript" src="resources/js/thickbox-compressed.js"></script>
    <!--[if lt IE 9]>
...
<body>
    ...
    <div class="guide text8">
        <a href="index">Home</a>
        <h2 class="index-bread">5 Gallon Water Bottle Caps</h2>
    </div>
    <div class="main">
        ...
        <div class="hidden" id="productId">${productId}</div>
    ...
    <script type="text/x-jsrender" id="template-product-detail">
		<div style=" border: 1px solid #c6d2e0; margin-bottom:8px">
			<div class="bbox" style="border:none;">
				<div class="tit" style="height: auto;padding: 5px; text-indent: 0;line-height: 18px;background: none;background:#fff;color:#333;font-family: arial;font-size:20px;line-height:24px;">
					<h1 class="index-top-tip index-top-tip3" style="padding:5px 6px 0 6px;">5 Gallon Water Bottle Covers 2 In 1 Add not leaking gasket 12. gram</h1>
				</div>
			</div>
			<div class="pfd">
				<div style="display:none">
					<form action="contactnow" method="POST"><input type="hidden" value="{{: data.id}}" name="pid" /><input type="hidden" value="1" name="from" /></form>
				</div>
				<dl class="le text8" style="display: inline; float: left; width: 324px;margin-bottom: 20px;">
					<dt>
						{{for data.pictures}}
							{{if #getIndex() == 0}}
								<a href="javascript:void(0);" title="{{: ~root.data.productName}}" id="largeimg" class="thickbox" pid="{{: ~root.data.id}}">
				            		<img src="{{: #data}}" onload="pic_reset(this,'312,222');" id="productImg"/>
								</a>
							{{/if}}
						{{/for}}
					</dt>
					<dd class="blk_18">
						<div class="pro">
							<div class="leb fleft">
								<a rel="nofollow" href="javascript:void(0)" onmousedown="ISL_GoUp_1(3)" onmouseup="ISL_StopUp_1()" onmouseout="ISL_StopUp_1()" target="_self"></a>
							</div>
								...
								<div class="ScrCont">
									<div id="List1_1">
										<table cellspacing="5" class="fleft">
											<tr>
												{{for data.pictures}}
													<td width="62" height="50" style="border:#dcdcdc solid 1px;">
														<a rel="nofollow" title="{{: ~root.data.productName}}">
															<img alt="{{: ~root.data.productName}}" src="{{: #data}}" onload="pic_reset(this, '55,35')" onclick="change_img({{: #getIndex()}},document.getElementById('productImg'))"/>
														</a>
													</td>
												{{/for}}
											</tr>
							...
							<div class="rib fright">
								<a rel="nofollow" title="{{: data.productName}}" href="javascript:void(0)" onmousedown="ISL_GoDown_1(3)" onmouseup="ISL_StopDown_1()" onmouseout="ISL_StopDown_1()" target="_self"></a>
							</div>
						</div>
						<p class="sear">
							...
							{{for data.pictures}}
								{{if #getIndex() == 0}}
									<a href="javascript:void(0);" title="{{: ~root.data.productName}}" id="large" pid="{{: ~root.data.id}}" class="thickbox">
				...
				<div class="ri">
					...
					<div class="clear"></div>
					<div class="sub">
						<form action="contactnow" method="POST">
			...
			<div class="detail" style="overflow: hidden;border-bottom: none;">
				<div style="margin: 15px 0"><b style=" font-size: 14px;">Detailed Product Description</b></div>
				<div style="width:100%; overflow: hidden;">
					<table class="customProperties" cellpadding="0" cellspacing="0" style="border:#dcdcdc solid 1px; margin:5px auto; text-align: left; width: 100%;font-size: 12px;">
						<tbody>
							<tr bgcolor="">
								<td style="color: #666; width: 110px;text-indent: 5px;padding: 8px 2px 8px 2px;">Material:</td>
								<td style="padding: 8px 2px 8px 2px;">Plastic （PE）</td>
								<td style="color: #666; width: 110px;text-indent: 5px;padding: 8px 2px 8px 2px;">Diameter:</td>
								<td style="padding: 8px 2px 8px 2px;">55.0mm</td>
							</tr>
							<tr bgcolor="#f1f1f1">
								<td style="color: #666; width: 110px;text-indent: 5px;padding: 8px 2px 8px 2px;">Height:</td>
								<td style="padding: 8px 2px 8px 2px;">38.5mm</td>
								<td style="color: #666; width: 110px;text-indent: 5px;padding: 8px 2px 8px 2px;">Application:</td>
								<td style="padding: 8px 2px 8px 2px;">55mm Bottle Neck</td>
							</tr>
							<tr bgcolor="">
								<td style="color: #666; width: 110px;text-indent: 5px;padding: 8px 2px 8px 2px;">Weight:</td>
								<td style="padding: 8px 2px 8px 2px;">12. Gram</td>
								<td style="color: #666; width: 110px;text-indent: 5px;padding: 8px 2px 8px 2px;">Safe & Healthy:</td>
								<td style="padding: 8px 2px 8px 2px;">Food Grade</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="text8 key" style=" padding: 6px 0 12px 0; margin-bottom: 10px;"><b style="font-size: 14px;">Tag </b>:
				{{if data.tag1 != ''}}
					<a href="products/tags/{{: data.tag1}}/view" title="China {{: data.tag1}} manufacturer">{{: data.tag1}}&#09;&#09;</a>
				{{/if}}
				{{if data.tag2 != ''}}
					<a href="products/tags/{{: data.tag2}}/view" title="China {{: data.tag2}} manufacturer"> {{: data.tag2}}&#09;&#09;</a>
				{{/if}}
				{{if data.tag3 != ''}}
					<a href="products/tags/{{: data.tag3}}/view" title="China {{: data.tag3}} manufacturer"> {{: data.tag3}}</a>
				{{/if}}
			    <div class="clear10"></div>
            </div>
			<div class="cd">
				...
				<div class="con">
					<div class="le">
						<strong>Shenzhen Baoan District Xixiang Jingli Plastic Products Factory，</strong>
						<p>Contact Person: <b>Mr. zeng</b></p>
						<p>Tel:<b>86-0755-29977990</b></p>
						<p>Fax:<b>86-0755-29977990</b></p>
						<P>
							<a class="i_m_g_3" style="background: none; " href="mailto:sales@szjlpg.com"><img src="resources/img/email_mini.gif" height="17"></a>
						</P>
					</div>
					<div class="ri text4">
    ...
    <script type="text/x-jsrender" id="template-img">
        <div id="TB_load">
            <img src="{{: src}}" width="320px" height="200px" onload="pic_reset(this, '310,200')"/>
        </div>
    </script>
    ...
    <script type="text/x-jsrender" id="template-contact-detail">
    	<div class="clear10"></div>
		<div class="cd">
			<div class="title">Contact Details</div>
			<div class="con">
				<div class="le">
					<strong>{{: aboutus.companyName}}</strong>
					<p>Contact Person: <b>{{: contactus.contactPerson}}</b></p>
					<p><b>{{: contactus.tellPhone}}</b></p>
					<p>Fax:<b>{{: contactus.fax}}</b></p>
					<P>
						<a class="i_m_g_3" style="background: none; " href="mailto:{{: contactus.email}}">
							<img src="resources/img/email_mini.gif" height="17">
						</a>
					</P>
				</div>
				<div class="ri text4">
