...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="resources/css/company.css" media="all" />
...
<body>
    ...
    <div class="header">
        ...
        <div class="menu textf">
            <ul id="head_menu">
                ...
                <li class="cur"><a href="aboutus">About Us</a></li>
    ...
    <div class="guide text8">
        <a href="index">Home</a>
        <span class="index-bread">About Us</span>
    </div>
    <div class="main">
    ...
    <script type="text/x-jsrender" id="template-aboutus">
    	<div class="r_pro bbox">
       		<div class="tit">
				<h1 class="cate-product-title">{{: aboutus.companyName}}</h1>
			</div>
			<div class="photo">
				<div class="le" style="position: relative;">
					...
					<div class="carousel-pictures">
						{{for aboutus.pictures}}
							<img class="hidden" onload="pic_reset(this,'420,350');" onerror ="this.onerror='';this.src='../resources/img/nophoto.gif'" style="vertical-align: middle" alt="{{: #parent.parent.companyName}}" src="{{: #data}}"/>
						{{/for}}
					</div>
					<div class="clear"></div>
				</div>
				<div class="ri" style="margin-top:12px;height:auto;">
					<h3>Company Details</h3>
					<table class="tables data" width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<th>Business Type:</th>
							<td>{{: aboutus.businessType}}</td>
						</tr>
						<tr>
							<th>Main Market:</th>
							<td>{{: aboutus.mainMarket}}</td>
						</tr>
						<tr>
							<th>Brands:</th>
							<td>{{: aboutus.brand}}</td>
						...
						<tr>
							...
							<td>{{: aboutus.employees}}</td>
						</tr>
						<tr>
							<th>Year Established:</th>
							<td>{{: aboutus.established}}</td>
						</tr>
						<tr>
							<th>Export p.c:</th>
							<td>{{: aboutus.export}}</td>
						</tr>
					</table>
				</div>
			</div>
			<div class="isho">
				<div class="but text8">
					<span class="cur"><a href='javascript:void(0);' title="Introduction">Introduction</a></span>
					<span><a href='javascript:void(0);' title="History">History</a></span>
					<span><a href='javascript:void(0);' title="Service" >Service</a></span>
					<span><a href='javascript:void(0);' title="Our Team">Our Team</a></span>
				</div>
				<div class="con">
					<div style="padding:10px;line-height:18px;">
						<div style="line-height:18px;" class="com-desc hidden">
