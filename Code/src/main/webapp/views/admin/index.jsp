        ...
        <div class="container-fluid">
            <div class="row">
                <div class="navbar-header col-md-3 col-sm-4">
                    <a class="navbar-brand" href="#" id="logo">精力塑胶管理系统
                    </a>
                </div>
                <div class="col-md-9 col-sm-8">
                    <a href="" class="navbar-logout col-md-1"><i class="glyphicon glyphicon-off" ></i>&nbsp;&nbsp;退出</a>
                    <a href="" class="navbar-user col-md-offset-9 col-md-2"><i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;${username}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/x-jsrender" id="template-factory">
			...
			<div class="col-md-10">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class=" col-sm-9">
							<input class="col-sm-5 form-control" type="text" id="company-detail" value="{{: data.detail}}" placeholder="请输入公司详情" required/>
							<p class="help-block">建议在20个单词以内</p>
						</div>
					</div><br />
					<div class="form-group">
        ...
        <script type="text/x-jsrender" id="template-product-list-advice">
			<div class="col-md-10">
				<center>
					<h1>产品列表</h1><br />
					<h3 style="color: orangered;font-weight: 400;">提示：先选择类别，推荐栏的该产品也会删除哦！</h3><br />
				</center>
			</div>
			<div class="col-sm-10">
				<div class="col-sm-12">
