...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="resources/css/factory.css" media="all" />
...
<body>
    ...
    <div class="header">
        ...
        <div class="menu textf">
            <ul id="head_menu">
                ...
                <li class="cur"><a href="factory">Factory Tour</a></li>
    ...
    <div class="guide text8">
        <a href="index">Home</a>
        <span class="index-bread">Factory Tour</span>
    </div>
    <div class="main">
...
<!-- static:2016-11-21 12:02:26 -->
    ...
    <script type="text/x-jsrender" id="template-factory-tour">
		<div class="r_pro bbox">
			<div class="tit"><h1 class="cate-product-title">{{: aboutus.companyName}}</h1></div>
			<div class="isho">
				<div class="but text8">
					<div class="factory cur">
						<a href="javascript:void(0)" rel="nofollow">Production Line</a>
					</div>
					<div class="factory">
						<a href="javascript:void(0)" rel="nofollow">OEM/ODM</a>
					</div>
					<div class="factory">
						<a href="javascript:void(0)" rel="nofollow">R&D</a>
					</div>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
				<div class="con" style="position: relative; height: 300px;">
					<div class="le" style="position:absolute; left: 0; top: 10px;">
						<div class="fleft carousel-pictures">
							{{if factoryTour.pictures1.length == 0}}
							    <img onload="pic_reset(this, '420,250');" style="vertical-align: middle" src="resources/img/waiting.gif" alt="">
							{{else}}
							    {{for factoryTour.pictures1}}
                                    {{if #getIndex() == 0 }}
                                        <img onload="pic_reset(this, '420,250');" style="vertical-align: middle" onerror="this.onerror='';this.src='resources/img/nophoto.gif'" src="{{: #data}}" alt="">
                                    {{else}}
                                        <img class="hidden" onload="pic_reset(this, '420,250');" style="vertical-align: middle" onerror="this.onerror='';this.src='resources/img/nophoto.gif'" src="{{: #data}}" alt="">
                                    {{/if}}
                                {{/for}}
							{{/if}}
						</div>
					...
					<div style=" width: 400px; left: 18px; position: absolute;  top: 28px;">
						{{for factoryTour.pictures1}}
							{{if #getIndex() == 0 }}
							    <span class="carousel-control active">{{: #getIndex() + 1}}</span>
							{{else}}
				...
				<div class="con hidden" style="position: relative; height: 300px;">
					<div class="le" style="position:absolute; left: 0; top: 10px;">
						<div class="fleft carousel-pictures">
							{{if factoryTour.pictures2.length == 0}}
                                <img onload="pic_reset(this, '420,250');" style="vertical-align: middle" src="resources/img/waiting.gif" alt="">
                            {{else}}
                                {{for factoryTour.pictures2}}
                                    {{if #getIndex() == 0 }}
                                        <img onload="pic_reset(this, '420,250');" style="vertical-align: middle" onerror="this.onerror='';this.src='resources/img/nophoto.gif'" src="{{: #data}}" alt="">
                                    {{else}}
                                        <img class="hidden" onload="pic_reset(this, '420,250');" style="vertical-align: middle" onerror="this.onerror='';this.src='resources/img/nophoto.gif'" src="{{: #data}}" alt="">
				...
				<div class="con hidden" style="position: relative; height: 300px;">
					<div class="le" style="position:absolute; left: 0; top: 10px;">
						<div class="fleft carousel-pictures">
							{{if factoryTour.pictures3.length == 0}}
                                <img onload="pic_reset(this, '420,250');" style="vertical-align: middle" src="resources/img/waiting.gif" alt="">
                            {{else}}
                                {{for factoryTour.pictures3}}
                                    {{if #getIndex() == 0 }}
                                        <img onload="pic_reset(this, '420,250');" style="vertical-align: middle" onerror="this.onerror='';this.src='resources/img/nophoto.gif'" src="{{: #data}}" alt="">
                                    {{else}}
                                        <img class="hidden" onload="pic_reset(this, '420,250');" style="vertical-align: middle" onerror="this.onerror='';this.src='resources/img/nophoto.gif'" src="{{: #data}}" alt="">
				...
				<div class="clear"></div>
				<div>
					<span style="font-weight:bold;">Production Line Profile</span>
				    <div>
				        {{for factoryTour.pictures4}}
				        	<p>&nbsp;</p>
							<p><img alt="" onload="pic_reset(this, '450,600');" src="{{: #data}}" style="height:450px; width:600px" /></p>
				        {{/for}}
						<p>&nbsp;</p>
						<p>&nbsp;</p>
					</div>
