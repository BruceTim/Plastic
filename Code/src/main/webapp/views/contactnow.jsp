                    ...
                    <td colspan="2" style="padding-top: 0">
                        ...
                        <table id="file" width="100%" cellspacing="0" style="background: #fff;display:none;" cellpadding="0" border="0">
                            ...
                            <tr>
                                ...
                                <td width="85%">
                                    <input size="40" type="file" onchange="getFileSize(this)" id="file1">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input size="40" type="file" onchange="getFileSize(this)" id="file2">
                                </td>
                            </tr>
                            <tr>
                                <th valign="top" scope="row" class="g_lab">
                                ...
                                <td>
                                    <input size="40" type="file" onchange="getFileSize(this)" id="file3">
                                </td>
                            </tr>
                            </tbody>
                        </table>
