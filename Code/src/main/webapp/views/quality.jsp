...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="resources/css/quality.css" media="all" />
...
<body>
    ...
    <div class="header">
        ...
        <div class="menu textf">
            <ul id="head_menu">
                ...
                <li class="cur"><a href="quality">Quality Control</a></li>
    ...
    <div class="guide text8">
        <a href="index">Home</a>
        <span class="index-bread">Quality Control</span>
    </div>
    <div class="main">
...
<!-- static:2016-11-21 12:02:26 -->
    ...
    <script type="text/x-jsrender" id="template-quality-control">
        <div class="r_pro bbox">
            <div class="tit">
                <h1 class="cate-product-title">{{: aboutus.companyName}}</h1>
            </div>
            <div class="qc">
                <strong>QC Profile</strong>
                <div class="con text8">
            ...
            <div class="ctf">
                ...
                <div style="height: auto; width: 340px;float: left;">
                    <div style="float:left;width:103px;">
                        <a href="{{: qualityControl.picture}}" target="_blank"><img style="width:74px;height:103px;" src="{{: qualityControl.picture}}" /></a>
                    </div>
                    <div style="float:left;width:237px;">
                        <p><b>Standard:</b>{{: qualityControl.standard}}</p>
                        <p><b>Number:</b>{{: qualityControl.number}}</p>
                        <p><b>Issue Date:</b>{{: qualityControl.issueDate}}</p>
                        <p><b>Expiry Date:</b>{{: qualityControl.expiryDate}}</p>
                    </div>
                </div>
            </div>
            <div class="clear10"></div>
