...
$(function() {
	...
	var pictureHanlder = {
		...
		remove : function ($this) {
			...
			if ($parent.hasClass('company-pictures')) {
				...
				$parent.empty();
				$.each(companyInfo.company.pictureUrls, function(index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="'+ picture +'"/><a href="javascript:void(0)" class="remove url"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				$.each(companyInfo.company.pictures, function(index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="'+ picture +'"/><a href="javascript:void(0)" class="remove"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				...
				$parent.empty();
				$.each(companyInfo.factory.productLine.pictureUrls, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove url"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				$.each(companyInfo.factory.productLine.pictures, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				...
				$parent.empty();
				$.each(companyInfo.factory.OEM.pictureUrls, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove url"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				$.each(companyInfo.factory.OEM.pictures, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				...
				$parent.empty();
				$.each(companyInfo.factory.RD.pictureUrls, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove url"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				$.each(companyInfo.factory.RD.pictures, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				...
				$parent.empty();
				$.each(companyInfo.factory.factory.pictureUrls, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove url"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
				$.each(companyInfo.factory.factory.pictures, function (index, picture) {
					$parent.append('<div class="picture-box"><img class="img-thumbnail picture" src="' + picture + '"/><a href="javascript:void(0)" class="remove"><i class="glyphicon glyphicon-remove"></i></a></div>');
				});
                    ...
                    success : function (res) {
                        if (res.success) {
                            if (type == 1) {
                                ...
                                alert('添加成功！');
                                window.open('products/' + res.data + '/view');
                            }
                        }
                    }
                });
	...
	$('#main-content').on('change', '.input-picture', function (event) {
		...
		var i = $(this).index($('.custom-properties .btn-property-delete'));
	...
	$('#main-nav').on('click', '#nav-btn-user-edit', function() {
		...
		$('#main-content').on('click', '#btn-product-list-search', function() {
			...
			window.open('products/' + id + '/detail');
		...
		$('.secondmenu li.active').removeClass('active');
		$(this).parent().addClass('active');
		var html = $('#template-product-advice').html();
		$('#main-content').html(html);
