...
//	CKEDITOR.instances.productContent.setData(product.data.content);
	...
	$('#product-content').on('change', '#js-file', function (event) {
		...
		$.each(pictures, function(index, picture) {
			$('.files').append('<div class="picture-box"><img class="img-thumbnail picture" src="'+ picture.base64 +'"/><a href="javascript:void(0)" class="remove"><i class="glyphicon glyphicon-remove"></i></a></div>');
		});
